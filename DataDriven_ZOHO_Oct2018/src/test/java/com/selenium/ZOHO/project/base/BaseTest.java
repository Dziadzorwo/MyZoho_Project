...
public class BaseTest {
	...
	public void init(){
		...
		if(prop==null){
			...
			try {
				...
				//fs = new FileInputStream(System.getProperty("C://Selenium//2020//Zoho//DataDriven_ZOHO_Oct2018//src//resources//prod.properties"));
				//prop.load(fs);
			   // envProp.load(fs);
			} catch (Exception e) {
	...
	public void openBrowser(String bType){
		...
		//if(!gridRun){
			if(bType.equals("Mozilla"))
				...
				//System.setProperty("webdriver.chrome.driver", "C:\\Selenium\\2020\\Zoho\\DataDriven_ZOHO_Oct2018\\webDrivers\\chromedriver_win32\\chromedriver.exe");
	...
	public void navigate(String urlKey){
		...
		System.out.println(prop.getProperty(urlKey)+" go now");
